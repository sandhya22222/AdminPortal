...
const StoreProductTypeGraph = ({ storeProductTypeData }) => {
    const [storeProductTypeColumnGraphData, setStoreProductTypeColumnGraphData] = useState()
    ...
    useEffect(() => {
        if (storeProductTypeData !== undefined) {
            let data = dataProcessorForLangugaes(storeProductTypeData && storeProductTypeData.store_product_type)
