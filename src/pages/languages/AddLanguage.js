...
import { Layout, Row, Col, Typography, Button, Input, Select, Spin, Upload, Radio } from 'antd'
...
const AddLanguage = () => {
    ...
    const handleNativeNameChange = (e) => {
        ...
        if (e.target.value !== '' && validator.matches(e.target.value, alphaWithSpacesRegex)) {
            setNativeName(e.target.value)
