            ...
            <Content
                className={`${
                    headerContent === undefined
                        ? 'shadow-sm fixed top-[3.0rem] z-10 bg-white flex justify-between headerWidth !px-5 pt-3 pb-1 '
                        : 'fixed top-[3.0rem] z-10 bg-white flex justify-between headerWidth !px-5 pt-3 pb-1 '
                }`}>
