        ...
        for (var j = 0; j < filterChildrenData.length; j++) {
            ...
            if (
                ...
                Childrens.push({
                    ...
                    store_product_type_revision: filterChildrenData[j].store_product_type_revision,
                })
            }
...
export const getParentChildrenCategories = (categories, storeProductTypes, isButtonRequired, parentCategory) => {
    console.log('categoriesinutil--->', categories)
    const parentChildrenData = []
    if (categories && categories.length > 0) {
        const filterParentCatgeories = filterCategoriesByParentCategoryId(parentCategory, categories)
        for (var i = 0; i < filterParentCatgeories.length > 0; i++) {
            ...
            const storeproductTypeRevisionName = filterParentCatgeories[i].store_product_type_name
            ...
            if (
                ...
                Children.push({
                    key: filterParentCatgeories[i].category_id + filterParentCatgeories[i].name,
                    ...
                    store_product_type_revision: filterParentCatgeories[i].store_product_type_revision,
                })
            }
            ...
            filterParentCatgeories[i]['store_product_type_revision_name'] = storeproductTypeRevisionName
...
// data variable will store the all children of particular parentcategoryid what we are send
export const getParentChildrenData = (dataProcessorData, storeProductTypes, isButtonRequired) => {
        ...
        if (dataProcessorData && dataProcessorData[0].children.length > 0) {
            ...
            if (
                ...
                copyDataProcessorData.push({
                    ...
                    store_product_type_revision: dataProcessorData[0].store_product_type_revision,
